...
class Martingale(bt.Strategy):
    ...
    def next(self):
            ...
            if tradeStatNumber == -1:
                ...
                orderVolumeLV0 = shareLV0 * minUSD /averagePriceLV0
                orderVolumeLV1 = shareLV1 * minUSD /averagePriceLV1
                orderVolumeLV2 = shareLV2 * minUSD /averagePriceLV2
                orderVolumeLV3 = shareLV3 * minUSD /averagePriceLV3
                orderVolumeLV4 = shareLV4 * minUSD /averagePriceLV4
                
                self.order = self.buy(size=orderVolumeLV0)
            ...
            if tradeStatNumber == 0 and self.data.close[0] / startPrice < dropLV1:
                self.order = self.buy(size=orderVolumeLV1)
            ...
            if tradeStatNumber == 1 and self.data.close[0] / startPrice < dropLV2:
                self.order = self.buy(size=orderVolumeLV2)
            ...
            if tradeStatNumber == 2 and self.data.close[0] / startPrice < dropLV3:
                self.order = self.buy(size=orderVolumeLV3)
            ...
            if tradeStatNumber == 3 and self.data.close[0] / startPrice < dropLV4:
                self.order = self.buy(size=orderVolumeLV4)
...
dataframe=pd.read_csv('ETHUSD_1h_k_2018_2022.csv')
