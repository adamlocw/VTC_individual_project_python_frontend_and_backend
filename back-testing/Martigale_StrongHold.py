...
class Martingale(bt.Strategy):
    ...
    def next(self):
            ...
            if tradeStatNumber == 0 and self.data.close[0] / startPrice < 0.99:
            ...
            if tradeStatNumber == 1 and self.data.close[0] / startPrice < 0.94:
            ...
            if tradeStatNumber == 2 and self.data.close[0] / startPrice < 0.69:
