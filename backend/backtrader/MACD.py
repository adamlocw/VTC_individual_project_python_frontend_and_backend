...
class firstMACD_Strategy(bt.Strategy):
    ...
    def __init__(self):
        self.macd = bt.indicators.MACD(
            self.data, period_me1=12, period_me2=26, period_signal=9)  # 12, 26, 9 - 5, 35, 5
...
brf_daily = bt.feeds.PandasData(dataname=dataframe, fromdate=datetime.datetime(
    2018, 1, 1, 0, 0), todate=datetime.datetime(2021, 12, 31, 0, 0))
